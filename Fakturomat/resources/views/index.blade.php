...
@section('content')
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <p class="masthead-subheading font-weight-light mb-0">Dbamy o to aby wszystkie Twoje faktury były w jednym miejscu!</p>
        </div>
    </header>
    <!-- Invoice List-->
    <section class="page-section portfolio" id="invoiceList">
        <div class="container">
            <!-- Section Heading-->
    ...
    <!-- Add invoice -->
    <section class="page-section" id="addInvoice">
        <div class="container">
